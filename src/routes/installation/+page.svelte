...
<main class="space-y-6">    
  ...
  <section id={routes.installation.ids.installing} data-title="Installing the Scaffold" class="space-y-4">
    <h2 class="sierra-docs-h2">Installing the Scaffold</h2>
    <h3>To get started, install the package via npm:</h3>
    <RenderCode
      lang="bash"
      code={`
  ...
  <section id={routes.installation.ids.scaffold_icons} data-title="Setting up Scaffold Icons" class="space-y-4">
    <h2 class="sierra-docs-h2">Setting up Scaffold Icons</h2>
    ...
    <h3>Create an account
      ...
      and follow <a href="https://docs.fontawesome.com/" class="note" target="_blank">these</a>
      instructions to make your own kit and get kit embed code.
    </h3>
    <h3>Add this to your layout</h3>
    <RenderCode
        lang="html"
        code={`
        <svelte:head>
