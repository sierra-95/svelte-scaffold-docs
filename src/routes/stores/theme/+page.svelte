...
<section id={sectionIds.stores.theme.theme_store} class="space-y-4">
...
<section id={sectionIds.stores.theme.theme_button} class="space-y-4">
    <h2>Theme Button</h2>
    <div class="flex items-start">
        <ButtonTheme />
    </div>
    <h3>The theme button simplifies integration by directly manipulating the theme store.</h3>
    <RenderCode
		lang="svelte"
		code={`
		<\script>
