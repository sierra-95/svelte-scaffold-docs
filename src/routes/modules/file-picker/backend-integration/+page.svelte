...
<main class="space-y-4">
    ...
    <ul class="list-disc list-inside space-y-2">
        <li>GET:<code>$fileInputStore.serverGetUrl</code> - used to load files onMount</li>
        <li>POST:<code>$fileInputStore.serverUploadUrl</code> - used to upload new files</li>
        <li><code>$fileInputStore.serverDownloadUrl</code> - Download files</li>
        <li>DELETE:<code>$fileInputStore.serverDeleteUrl</code> - used to delete files</li>
    </ul>
    ...
    <section class="space-y-4">
        ...
        <h2 class="sierra-docs-h2">Creating your +server.js (/api/media/upload) or $fileInputStore.serverUploadUrl</h2>
        ...
        <h2 class="sierra-docs-h2">Creating your backend</h2>
