...
<section id={sectionIds.modules.layout.features.RBAC} class="space-y-4 mb-10">
    <h2>3. RBAC <span class="text-sm text-blue-500">(beta)</span></h2>
    ...
    <ol>
        <li>
            a. Define your application's <code>ROLE_LEVELS</code>. Role levels are incremental, with higher levels having more permissions.
        </li>
        <li>
            b. Assign roles to users within your application's authentication system.
        </li>
    </ol>
    <RenderCode
        lang="js"
    ...
    <ol>
        <li>
            c. The sections file allows you to specify which categories of paths can be accessed by users with specific roles.
        </li>
    </ol>
        <RenderCode
        lang="javascript"
